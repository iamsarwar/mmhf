    ...
    <script>
        ...
        function go_city(){
            ...
            jQuery.ajax({
                ...
                type: \'POST\',
                data: \'action=addtrip_city&trip_no=\' + trip_no + \'&extra_trip=\' + extra_trip + \'&user_id=\' + user_id + \'&gea_subscription_id=\' + gea_subscription_id + \'&invoice_id=\' + invoice_id + \'&vehicle_type=\' + vehicle_type+ \'&amount=\' + amount,
        ...
        function go_nagad(){
            ...
            jQuery.ajax({
                url: "'.get_bloginfo('url').'/wp-admin/admin-ajax.php",
                type: \'POST\',
                data: \'action=addtrip_nagad&trip_no=\' + trip_no + \'&extra_trip=\' + extra_trip + \'&user_id=\' + user_id + \'&gea_subscription_id=\' + gea_subscription_id + \'&invoice_id=\' + invoice_id + \'&vehicle_type=\' + vehicle_type+ \'&amount=\' + amount,
                success: function (results) {
                    //var url = results.slice(0, -1);
                    //alert(results);
