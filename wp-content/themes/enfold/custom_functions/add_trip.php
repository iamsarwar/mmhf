...
function my_custom_endpoint_content() {
    ...
    <form id="trip_form" name="trip_form" class="woocomerce-form woocommerce-form-login login" method="post" style="display:none;min-height:600px;">
        ...
        <table width="100%" class="table table-striped table-bordered text-center" id="package_table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>30</td>
                    <td>375</td>
                    <td><button type="button" class="button" onclick="grab_package(345,30)">Grab Package</button></td>
                </tr>
                <tr>
                    <td>Package_12</td>
                    <td>460</td>
                    <td>40</td>
                    <td>500</td>
                    <td><button type="button" class="button" onclick="grab_package(460,40)">Grab Package</button></td>
                </tr>
            </tbody>
        </table>
        ...
        <button id="nexus_button" onclick="go_dbbl(1)" class="button" style="display:none;" type="button">Deposit</button>
    ...
    <script>
        ...
        function go_city(){
            ...
            jQuery.ajax({
                ...
                type: \'POST\',
                data: \'action=addtrip_city&trip_no=\' + trip_no + \'&extra_trip=\' + extra_trip + \'&user_id=\' + user_id + \'&gea_subscription_id=\' + gea_subscription_id + \'&invoice_id=\' + invoice_id + \'&vehicle_type=\' + vehicle_type+ \'&amount=\' + amount + \'&security=\' + ajax_object.ajax_nonce,
        ...
        function go_nagad(){
            ...
            jQuery.ajax({
                url: ajax_object.ajax_url,
                type: \'POST\',
                data: \'action=addtrip_nagad&trip_no=\' + trip_no + \'&extra_trip=\' + extra_trip + \'&user_id=\' + user_id + \'&gea_subscription_id=\' + gea_subscription_id + \'&invoice_id=\' + invoice_id + \'&vehicle_type=\' + vehicle_type+ \'&amount=\' + amount + \'&security=\' + ajax_object.ajax_nonce,
                success: function (results) {
                    //var url = results.slice(0, -1);
                    //alert(results);
        ...
        function go_dbbl(card_type){
            ...
            jQuery.ajax({
                url: ajax_object.ajax_url,
                type: \'POST\',
                data: \'action=addtrip_dbbl&trip_no=\' + trip_no + \'&extra_trip=\' + extra_trip + \'&user_id=\' + user_id + \'&gea_subscription_id=\' + gea_subscription_id + \'&invoice_id=\' + invoice_id + \'&vehicle_type=\' + vehicle_type+ \'&amount=\' + amount + \'&card_type=\' + card_type,
                success: function (results) {
                    var url = results.slice(0, -1);
                    //alert(results);
                    //console.log(results);
        ...
        function go_upay(){
            ...
            jQuery.ajax({
                url: ajax_object.ajax_url,
                type: \'POST\',
                data: \'action=addtrip_upay&trip_no=\' + trip_no + \'&extra_trip=\' + extra_trip + \'&user_id=\' + user_id + \'&gea_subscription_id=\' + gea_subscription_id + \'&invoice_id=\' + invoice_id + \'&vehicle_type=\' + vehicle_type + \'&amount=\' + amount + \'&user_login=\' + user_login,
                success: function (results) {
                    //var url = results.slice(0, -1);
                    //alert(results);
                    window.location.href = results;
	...
	<script type="text/javascript">
        $(document).ready(function () {
			...
			$.post(ajax_object.ajax_url, { action: \'bkash_token\' }, function(output) {
				//location.reload();
		...
		//		output = output.substring(0, output.length - 1);
			...
			bKash.init({
				...
				createRequest: function (request) {
					...
					$.post(ajax_object.ajax_url, { action: \'bkash_createpayment\', amount: paymentRequest.amount, invoice: paymentRequest.invoice }, function(output) {
						//location.reload();
						output = output.substring(0, output.length - 1);
						//alert(output);
				...
				executeRequestOnAuthorization: function () {
					...
					$.post(ajax_object.ajax_url, { action: \'bkash_executepayment\', paymentID: paymentID }, function(output) {
						//location.reload();
                                                if (output != null) {
						output = output.substring(0, output.length - 1);
                                                //alert(output);
