...
?>
    ...
    //if(!empty(get_current_user_id())) {
        ...
        //$reg_data = json_decode(stripslashes($_COOKIE['mmhftrip_data']));
        //echo '<pre>';
        //var_dump($reg_data);
        //echo '</pre>';
...
$extra_trip = $wpdb->escape($trip_data->extra_trip);
            ...
            if(str_contains($gea_subscription_id, "\'")){
		$gea_subscription_id = str_replace("\'",'',$gea_subscription_id);
	    }
